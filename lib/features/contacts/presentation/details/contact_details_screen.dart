...
import '../shared/confirm_delete_contact_dialog.dart';
import '../../../../screens/contact_details/widgets/contact_info_widgets.dart';
                  ...
                  child: Padding(
                    ...
                    child: Wrap(
                      ...
                      children: <Widget>[
                        ...
                        Obx(() {
                          final fav =
                              controller.contact.value?.isFavorite ?? false;
                      ...
                      children: <Widget>[
                        ...
                        Material(
                          ...
                          child: ListTile(
                            ...
                            subtitle: const Text(
                              'Remove this contact from your phone',
                            ),
                            onTap: () async {
                              final ok = await ConfirmDeleteContactDialog.show(
                                context,
                                contact: contact,
                              );
                              if (!ok) return;
